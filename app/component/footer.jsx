const Footer = () => {
  return (
    <footer className="bg-white mt-8 md:mt-10 lg:mt-12 shadow-2xl border-t border-slate-200">
      <div className="mx-auto container px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-sm text-gray-500">
            Explore thousands of titles, from blockbusters to hidden gems — all
            in one app built for movie lovers.
          </p>
